...
3ds Max (3D-Modelling), Photoshop (2D), Engine: Unity **oder** s&box (offen). Auswahl basiert auf Teamkompetenz und praktisch validierten Prototypen (TAD, Felsing, 2026).
