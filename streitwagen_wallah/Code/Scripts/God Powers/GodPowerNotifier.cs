...
/// razor reads <see cref="CurrentText"/> each frame and renders it small at the
/// top-center of the screen (see the .power-message style).
///
...
public sealed class GodPowerNotifier : Component
{
	...
	/// effect can end early (e.g. a shield being consumed). The message clears as
	/// soon as <paramref name="remainingFunc"/> returns &lt;= 0.
	/// </summary>
